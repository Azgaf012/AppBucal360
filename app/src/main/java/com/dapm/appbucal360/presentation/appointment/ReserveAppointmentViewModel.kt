...
class ReserveAppointmentViewModel @Inject constructor(
    ...
    private val _doctorsList = MutableLiveData<List<String>>()
    val doctorsList: LiveData<List<String>> get() = _doctorsList

    fun registerAppointment(doctor: String, date: Date, patient: User, time: String) {
